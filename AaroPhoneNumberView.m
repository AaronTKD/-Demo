...
- (void)creatPhoneNumberTextField{
    ...
    phoneNumberTextField.backgroundColor = AaroPhoneTextColor;
    phoneNumberTextField.frame = CGRectMake(0, 0, kPhoneNumberTextFieldWidth, kPhoneNumberViewHeight);
    phoneNumberTextField.left = verticalLine.right + kPhoneNumberTextFieldLeftGap;
    [self addSubview:phoneNumberTextField];
    phoneNumberTextField.placeholder = phoneNumberPlaceHolderString;
